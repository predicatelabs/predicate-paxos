...
program
  .option("--predicate-api-url <url>", "Predicate API URL", config.predicateAPIURL)
  ...
  .option("--currency0-address <address>", "Currency0 address", config.currency0Address)
  .option("--currency1-address <address>", "Currency1 address", config.currency1Address)
  .option("--swap-router-address <address>", "Swap router address", config.routerAddress)
  .option("--hook-address <address>", "Hook address", config.hookAddress)
  .option("--lp-fees <number>", "LP fees", (val) => parseInt(val), config.lpFees)
  .option("--tick-spacing <number>", "Tick spacing", (val) => parseInt(val), config.tickSpacing);
