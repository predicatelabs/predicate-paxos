...
function getConfig(): Config {
    return {
        ...
        currency0Address: process.env.CURRENCY0_ADDRESS || '0x0DCd1Bf9A1b36cE34237eEaFef220932846BCD82',
        currency1Address: process.env.CURRENCY1_ADDRESS || '0xA51c1fc2f0D1a1b8494Ed1FE312d7C3a78Ed91C0',
